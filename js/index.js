...
//---------------------------
const style = window.localStorage.getItem("togg")==true ? 'rgb(230,230,230)' : "rgb(22,22,22)";
document.getElementsByTagName("body").style ="background-color:"+style;
...
window.localStorage.setItem("togg",toggle)
